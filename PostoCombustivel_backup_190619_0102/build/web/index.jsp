            ...
            try{
                ...
                if(request.getParameter("descricao") == "" || request.getParameter("descricao") == null){
                    ...
                    for(int num = 0; num < lista.size(); num++){
                        ...
                        out.print("<td><b> Total cadastros: "+lista.get(num).getTotal_quantidade_cod()+"</b></td>");
            ...
            try{
                ...
                if(request.getParameter("descricao") == "" || request.getParameter("descricao") == null){
                    ...
                    for(int num = 0; num < lista.size(); num++){
                        ...
                        out.print("<td><b> Total Gasolina: "+lista.get(num).getTotal_gasolina()+"</b></td>");
            ...
            try{
                ...
                if(request.getParameter("descricao") == "" || request.getParameter("descricao") == null){
                    ...
                    for(int num = 0; num < lista.size(); num++){
                        ...
                        out.print("<td><b> Total Alcool: "+lista.get(num).getTotal_alcool()+"</b></td>");
